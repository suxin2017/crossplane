...
export const NGX_CONF_NOARGS = 0x00000001  //# 0 args
export const NGX_CONF_TAKE1 = 0x00000002  //# 1 args
export const NGX_CONF_TAKE2 = 0x00000004  //# 2 args
export const NGX_CONF_TAKE3 = 0x00000008  //# 3 args
export const NGX_CONF_TAKE4 = 0x00000010  //# 4 args
export const NGX_CONF_TAKE5 = 0x00000020  //# 5 args
export const NGX_CONF_TAKE6 = 0x00000040  //# 6 args
export const NGX_CONF_TAKE7 = 0x00000080  //# 7 args
export const NGX_CONF_BLOCK = 0x00000100  //# followed by block
export const NGX_CONF_FLAG = 0x00000200  //# 'on' or 'off'
export const NGX_CONF_ANY = 0x00000400  //# >=0 args
export const NGX_CONF_1MORE = 0x00000800  //# >=1 args
export const NGX_CONF_2MORE = 0x00001000  //# >=2 args

// //# some helpful argument style aliases
export const NGX_CONF_TAKE12 = (NGX_CONF_TAKE1 | NGX_CONF_TAKE2)
export const NGX_CONF_TAKE13 = (NGX_CONF_TAKE1 | NGX_CONF_TAKE3)
export const NGX_CONF_TAKE23 = (NGX_CONF_TAKE2 | NGX_CONF_TAKE3)
export const NGX_CONF_TAKE34 = (NGX_CONF_TAKE3 | NGX_CONF_TAKE4)
export const NGX_CONF_TAKE123 = (NGX_CONF_TAKE12 | NGX_CONF_TAKE3)
export const NGX_CONF_TAKE1234 = (NGX_CONF_TAKE123 | NGX_CONF_TAKE4)

// //# bit masks for different directive locations
export const NGX_DIRECT_CONF = 0x00010000  //# main file (not used)
export const NGX_MAIN_CONF = 0x00040000  //# main context
export const NGX_EVENT_CONF = 0x00080000  //# events
export const NGX_MAIL_MAIN_CONF = 0x00100000  //# mail
export const NGX_MAIL_SRV_CONF = 0x00200000  //# mail > server
export const NGX_STREAM_MAIN_CONF = 0x00400000  //# stream
export const NGX_STREAM_SRV_CONF = 0x00800000  //# stream > server
export const NGX_STREAM_UPS_CONF = 0x01000000  //# stream > upstream
export const NGX_HTTP_MAIN_CONF = 0x02000000  //# http
export const NGX_HTTP_SRV_CONF = 0x04000000  //# http > server
export const NGX_HTTP_LOC_CONF = 0x08000000  //# http > location
export const NGX_HTTP_UPS_CONF = 0x10000000  //# http > upstream
export const NGX_HTTP_SIF_CONF = 0x20000000  //# http > server > if
export const NGX_HTTP_LIF_CONF = 0x40000000  //# http > location > if
export const NGX_HTTP_LMT_CONF = 0x80000000  //# http > location > limit_except
...
// """
export const DIRECTIVES: Record<string, number[]> = {
    'absolute_redirect': [
...
export const CONTEXTS = {
    [[].toString()]: NGX_MAIN_CONF,
    [['events',].toString()]: NGX_EVENT_CONF,
    [['mail',].toString()]: NGX_MAIL_MAIN_CONF,
    [['mail', 'server'].toString()]: NGX_MAIL_SRV_CONF,
    [['stream',].toString()]: NGX_STREAM_MAIN_CONF,
    [['stream', 'server'].toString()]: NGX_STREAM_SRV_CONF,
    [['stream', 'upstream'].toString()]: NGX_STREAM_UPS_CONF,
    [['http',].toString()]: NGX_HTTP_MAIN_CONF,
    [['http', 'server'].toString()]: NGX_HTTP_SRV_CONF,
    [['http', 'location'].toString()]: NGX_HTTP_LOC_CONF,
    [['http', 'upstream'].toString()]: NGX_HTTP_UPS_CONF,
    [['http', 'server', 'if'].toString()]: NGX_HTTP_SIF_CONF,
    [['http', 'location', 'if'].toString()]: NGX_HTTP_LIF_CONF,
    [['http', 'location', 'limit_except'].toString()]: NGX_HTTP_LMT_CONF
}